...
class Resource{
    ...
    setResource(file){
        if(!file){
            ...
            this.loader.load("fbx/StaticMesh1.FBX", (object) => { // 3호기 집게
            ...
            this.loader.load("fbx/StaticMesh2.FBX", (object) => { // 3호기 집게 축
            ...
            this.loader.load("fbx/StaticMesh3.FBX", (object) => { // 3호기 Y축
            ...
            this.loader.load("fbx/StaticMesh4.FBX", (object) => { // 3호기 몸체
